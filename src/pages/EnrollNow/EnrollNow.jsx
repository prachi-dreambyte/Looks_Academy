...
const ContactForm = () => {
  ...
  const WHATSAPP_NUMBER = "8006022277";
  const courses = [
    "ARTH Course",
    "Makeup Course (Basic)",
...
`;
    ...
    // ✅ Only add alternate phone if user entered it
    if (data.alternatePhone) {
      message += `Alternate Phone: ${data.alternatePhone}\n`;
    }

    message += `
Course: ${data.course}

Sent from Looks Academy Website
`;
            ...
            <div className="form-content">
              <div className="header">
                ...
                <p className="subtitle">
                  Looks Salon, one of India's fastest-growing pan-India salon
                  chains, has set new benchmarks in the hairstyling industry.{" "}
                </p>
              </div>
              ...
              <div className="contact-form">
                ...
                <div className="form-group checkbox-group">
                  ...
                  {errors.robot && (
                    <span className="error-text">{errors.robot.message}</span>
                  )}
                </div>
