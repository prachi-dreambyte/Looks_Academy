...
const AllGalleryBanner = () => {
  ...
  const API_URL = `${API_BASE_URL}/api/gallery-banner`;
  ...
  return (
    <div className="container py-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <h4 className="fw-semibold mb-0">Gallery Banner</h4>
      ...
      {!banner && (
        <div className="card text-center p-4 shadow-sm border-0">
          <p className="text-muted mb-0">No gallery banner uploaded</p>
        </div>
      )}
...
export default AllGalleryBanner;
