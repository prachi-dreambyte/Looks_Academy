  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE_URL}/api/about-banner/create`,
        {
          method: "POST",
          body: formData,
        }
  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.card}>
        <h2 className={styles.title}>Update About Us Banner</h2>
        <p className={styles.subtitle}>
          Upload a banner image for About Us page
        </p>
